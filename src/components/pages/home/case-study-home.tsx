...
const CaseStudyHome = () => {
  return (
    <div data-navbar-color="dark">
      <main className="relative isolate bg-gradient-brand pb-16">
        <div className="px-6 lg:px-8">
          <div className="mx-auto max-w-5xl text-center uppercase">
            <h2 className="subheader-light pt-16" style={{ lineHeight: '1.5' }}>
              How{' '}
              <span className="inline-flex items-center bg-white px-3 leading-none">
                <span className="header-gradient">Earthly</span>
              </span>{' '}
