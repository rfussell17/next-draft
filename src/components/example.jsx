...
export default function Example() {
  return (
    <Popover className="relative isolate z-50 shadow-sm">
      ...
      <PopoverPanel
        transition
        className="data-closed:-translate-y-1 data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in absolute inset-x-0 top-0 -z-10 bg-white pt-16 shadow-lg ring-1 ring-gray-900/5 transition"
      >
