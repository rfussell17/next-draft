            ...
            <div className="mx-auto max-w-2xl gap-x-12 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
              <div className="relative w-full lg:max-w-2xl lg:shrink-0 xl:max-w-3xl">
                ...
                <div className="mt-16 flex items-center gap-x-6">
                  <a
                    href="#"
                    className="rounded-sm px-3.5 py-2.5 text-base font-semibold text-gray-100 shadow-sm ring-1 ring-white hover:text-white hover:ring-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
                  >
